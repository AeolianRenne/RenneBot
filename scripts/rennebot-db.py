...
def main() -> None:
    ...
    parser.add_argument("--database", type=Path, required=True, help="Path to rennebot.sqlite3")
    subparsers = parser.add_subparsers(dest="command", required=True)
    subparsers.add_parser("show", help="Show configured administrators and AI allowlists")
    ...
    if arguments.command == "set":
        database.set_setting(SETTING_ALIASES[arguments.setting], sorted(set(arguments.ids)))
